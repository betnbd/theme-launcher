...
- Changed Brave theming to use profile-level autogenerated theme preferences and to remove the older managed Brave color policy, which blocked fuller Brave chrome theming.
